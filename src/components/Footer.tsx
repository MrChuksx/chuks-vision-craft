...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="relative py-32 md:py-48 section-padding overflow-hidden">
      {/* Top divider */}
      <motion.div
        initial={{ scaleX: 0 }}
      ...
      <div ref={ref} className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-border/50">
          <span className="text-xs text-dim font-body tracking-wide">
            © {new Date().getFullYear()} MrChuks. All rights reserved.
          </span>
          <span className="text-xs text-dim font-body tracking-wide">
            Designed & Built by{" "}
            <span className="text-muted-foreground">Uchechukwu Godspower</span>
          </span>
        </div>
      </div>
    </footer>
